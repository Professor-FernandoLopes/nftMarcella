...
// dá acesso ao web3 and contract
const { web3, contract } = useWeb3()
//importante
const { account } = useAdmin({redirectTo: "/marketplace"})

// vai passar a conta do usuário
...
/**
* Aqui eu tenho acesso a struct Course e com o uso da notação
* . eu consigo acessar as informações do curso
*/
...
// pega aparentemente cada um dos cursos
// passa para a variável filteredCourses
...
<h1 className="text-2xl font-bold p-5">All Properties</h1>
{ filteredCourses }
