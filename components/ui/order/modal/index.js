...
return _createFormState(true, "Secret are not matching.")
}
}

if (!hasAgreedTOS) {
return _createFormState(true, "Você precisa ler e concordar com o NFT CONTRACT antes de realizar a compra")
}
...
<div className="mb-1">
<label className="mb-2 font-bold text-blue2">Price(matic)</label>
...
<span>Ajuste o preço - apenas se for autorizado</span>
</div>
</div>
<input
...
O preço será verificado no momento da compra. Se o preço estiver errado você deverá complementar o valor conforme NFT CONTRACT (+- 2% slipage é permitido)
</p>
</div>
{ isNewPurchase &&
<>
...
<div className="mb-1">
<label className="mb-2 font-bold text-blue2">Secret</label>
</div>
<input
onChange={({target: {value}}) => {
setOrder({
...
É&apos;importante criar e guardar o secret, pois comprovará a compra do cupom.
</p>
</div>
<div className="my-2 relative rounded-md">
<div className="mb-1">
<label className="mb-2 font-bold text-blue2">Repita o Secret</label>
</div>
<input
onChange={({target: {value}}) => {
setOrder({
